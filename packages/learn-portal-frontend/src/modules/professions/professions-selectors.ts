...
export const getProfessionsState = (state): TProfessionsStore => state[PROFESSIONS_STORE_NAME];

export const getProfessions = createSelector(
  getProfessionsState,
  (professionsState: TProfessionsStore): TProfession[] | null => professionsState.professions
);
